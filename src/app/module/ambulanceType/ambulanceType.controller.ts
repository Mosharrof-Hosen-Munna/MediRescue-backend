...
const createAmbulanceType = catchAsync(async (req: Request, res: Response) => {
	const result = await ambulanceTypeService.createAmbulanceType(req.body);
...
const getAmbulanceTypes = catchAsync(async (req: Request, res: Response) => {
	const result = await ambulanceTypeService.getAmbulanceTypes(req.query);
...
const getAmbulanceTypeById = catchAsync(async (req: Request, res: Response) => {
...
const updateAmbulanceType = catchAsync(async (req: Request, res: Response) => {
...
const deleteAmbulanceType = catchAsync(async (req: Request, res: Response) => {
